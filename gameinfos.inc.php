...
$gameinfos = [
    ...
    'tie_breaker_description' => totranslate("Total points values on the tiles left in their supply"),
    ...
    'presentation' => array(
            totranslate("Bear parks: it's the next big thing! In order to be successful, you must skillfully fit together enclosures, animal houses and green areas, and use every available inch of your land. Animal houses and enclosures are worth points, and are more valuable if you build them quickly."),
            totranslate("Construction crews let you claim more land to build onto. When one player fills their park, the game is over and the player with the most points wins."),
    ),
