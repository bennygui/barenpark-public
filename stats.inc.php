...
$stats_type = [
    ...
    "player" => [
        ...
        STATS_PLAYER_SCORE_SOUVENIR_SHOP => ["id" => 21, "name" => totranslate("Player Score: Souvenir Shops"), "type" => "int"],
        ...
        STATS_PLAYER_NB_PLACED_SHAPE_SOUVENIR_SHOP => ["id" => 22, "name" => totranslate("Nb Placed Tiles: Souvenir Shops"), "type" => "int"],
